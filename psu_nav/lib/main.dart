    ...
    return _ResponsiveList(
      ...
      children: [
        const _InfoCard(
          ...
          title: 'thanapon@email.psu.ac.th',
          subtitle: 'JWT session · PSU SSO ready for next version',
          trailing: _RightPill('student'),
        ),
        _InfoCard(
          icon: Icons.notifications_outlined,
          title: 'ตารางเรียนและกิจกรรม',
          subtitle: 'ENG-302 เริ่ม 09:00 · เตือนในแอปและอีเมลก่อน 15 นาที',
